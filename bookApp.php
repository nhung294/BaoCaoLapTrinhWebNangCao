...
if (isset($_GET['act'])) {
  switch ($_GET['act']) {
    ...
    case 'logout': {
        ...
        header('location: bookApp.php?act=home');
        break;
      }
    ...
    case 'checkout': {
        if (!isset($_SESSION['iduser'])) {
          header('Location: bookApp.php?act=login');
          exit;
        }
        ...
        if (isset($_POST['submit']) && $_POST['submit']) {
          if (isset($_POST['user_c'])) {
            ...
            if ($check == 1) {
              ...
              header('location: bookApp.php?act=login_sc');
              break;
            }
          }
        }
