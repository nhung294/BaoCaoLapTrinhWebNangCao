<?php
    ...
    function addtocart($iddh, $id, $name, $img, $price, $quantity){
        $conn = connectdb();
        $sql = "INSERT INTO tbl_cart(id_order, id_pro, quantity, prices, name_pro, img_pro)
                VALUES ('$iddh', '$id', '$quantity', '$price', '$name', '$img')";
        $conn->exec($sql);
    }
