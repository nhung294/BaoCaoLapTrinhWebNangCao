                ...
                <div class="row">
                        ...
                        <div class="axil-footer-widget">
                            ...
                            <div class="inner">
                                ...
                                <ul class="support-list-item">
                                    <li><a href="mailto:yenni@example.com"><i
                                                class="fal fa-envelope-open"></i>yenni@example.com</a></li>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="axil-footer-widget">
                            ...
                            <div class="inner">
                                <ul>
                                    <li><a>Tran Thi Vy - 22810340255</a></li>
                                    <li><a>Duong Thi Nhung - 22810340436</a></li>
                                    <li><a>Trinh Thi Thuy Nga - 22810340068</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-4 col-lg-12">
                        <div class="copyright-left d-flex flex-wrap justify-content-center">
                            <ul class="quick-link">
                                <li>© 2025. All rights reserved by Group 3 members</li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-12">
