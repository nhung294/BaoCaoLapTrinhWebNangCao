    ...
    <div class="row align-items-center">
        ...
        <div class="col-md-6">
            <div class="singin-header-btn">
                <a href="bookApp.php?act=login" class="axil-btn btn-bg-secondary sign-up-btn">Sign In</a>
            </div>
        </div>
    </div>
</div>
...
<div style="margin-top: 50px;">
    <div class="col-lg-6 offset-xl-3">
        ...
        <form action="bookApp.php?act=insert_client_user" method="POST" class="singin-form">
