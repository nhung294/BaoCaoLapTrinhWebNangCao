...
<div class="axil-signin-area">
    ...
    <div class="signin-header">
        <div class="row align-items-center">
            <div class="col-sm-4">
                <a href="bookApp.php" class="site-logo"><img src="../assets/images/logo/login-logo.png" alt="logo"></a>
            </div>
            <div class="col-sm-8">
                <div class="singin-header-btn">
                    <p>Not a member?</p>
                    <a href="bookApp.php?act=insert_client_user&id='1'" class="axil-btn btn-bg-secondary sign-up-btn">Sign
                        Up Now</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-6 offset-xl-2">
            <div class="axil-signin-form-wrap">
                <div class="axil-signin-form">
                    <h3 class="title">Sign in to THE YENNI.</h3>
                    <p class="b2 mb--55">Enter your detail below</p>
                    <form action="bookApp.php?act=login_account_user" method="POST" class="singin-form">
