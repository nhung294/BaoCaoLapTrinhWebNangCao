                    ...
                    foreach ($kq as $invoice) {
                      echo '
                        ...
                        if($invoice['status'] == "Cancel")
                        {
                          echo'
                          <td>
                            <button  class="button-detail"><a class="change-a" href="../web_user/bookApp.php?act=print_invoice_admin&iddh='.$invoice['id'].'">Details</a></button> 
                          </td>
                        </tr>';
                        } 
                        // elseif($invoice['status'] == "Delivered")
                        ...
                        // }
                          ...
                          <td>
                            ...
                            <button  class="button-detail"><a class="change-a" href="../web_user/bookApp.php?act=print_invoice_admin&iddh='.$invoice['id'].'">Details</a></button> 
                            <button  class="button-print"><a class="change-a" href="../web_user/bookApp.php?act=print_invoice_admin&iddh='.$invoice['id'].'">Print</a></button> 
                          </td>
                        </tr>';
                        }
                      $i++;
